 ...
 * @requires PHP 5.6.28
 */
class EventResourceManagementCopiedTest extends CaliperTestCase {
    function setUp() {
        parent::setUp();
        ...
        $this->setTestObject(
            (new ResourceManagementEvent('urn:uuid:d3543a73-e307-4190-a755-5ce7b3187bc5'))
                ...
                ->setGenerated(
                    (new DigitalResource('https://example.edu/terms/201801/courses/7/sections/1/resources/1/syllabus_copy.pdf'))
                        ->setName('Course Syllabus (copy)')
                        ->setMediaType('application/pdf')
                        ->setCreators(
                            [
                                (new Person('https://example.edu/users/554433'))
