 ...
 * @requires PHP 5.6.28
 */
class EventSurveyInvitationAcceptedTest extends CaliperTestCase {
    function setUp() {
        parent::setUp();


        $this->setTestObject(
            (new SurveyInvitationEvent('urn:uuid:534afa10-3564-11e9-b210-d663bd873d93'))
                ->setActor(
